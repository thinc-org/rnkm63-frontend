...
class Loading extends React.PureComponent {
  ...
  render() {
    return <LoadingInner filled={this.state.filled} />
  }
}

interface LoadingInnerProps {
  filled: boolean
}

function LoadingInner(props: LoadingInnerProps) {
      ...
      >
        <path
          ...
          className={`${classes.pathAnim} ${
            filled ? classes.filled : classes.empty
          }`}
        ></path>
      </svg>
      <h3>Loading</h3>
