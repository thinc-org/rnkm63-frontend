**Note:**    These COVID-19 Measures are to be followed by both participants and staffs of Rubnongkaomai 2020 event.
...
* All staffs and participants are required to pass through screening checkpoints before participating in the event.
  - In the case where the participant’s temperature is higher than 37.5 degree Celsius, they will be escorted to an isolated observation zone to be screened further. If the temperature is still higher, they will be declined entry to the event.
...
* Sharing food, drinks, and utensils inside the event is prohibited.
